...
dataset_names=['big_cfo.mat','big_cfo.mat']#,'../../../../baseline_dataset1024_iqenergy_hardware_sco.mat']
...
def gen_data():
    ...
    for dataset_name in dataset_names:
        ...
        for key in ds.keys():
            ...
            c=np.full((total_len_a,5),[mod,snr,sps,nt,cfo])

...
if parse:
    ...
    max_norm()
    transform_input()
    np.save("X_train_all_snr.npy",X_train)
    np.save("Y_train_all_snr.npy",Y_train)
    np.save("snr_mod_pairs_train_all_snr.npy",snr_mod_pairs_train)

    np.save("X_valid_all_snr.npy",X_valid)
    np.save("Y_valid_all_snr.npy",Y_valid)
    np.save("snr_mod_pairs_valid_all_snr.npy",snr_mod_pairs_valid)

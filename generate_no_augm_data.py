...
if parse:
    ...
    max_norm()
    transform_input()
    np.save("X_train_no_augm.npy",X_train)
    np.save("Y_train_no_augm.npy",Y_train)
    np.save("snr_mod_pairs_train_no_augm.npy",snr_mod_pairs_train)

    np.save("X_valid_no_augm.npy",X_valid)
    np.save("Y_valid_no_augm.npy",Y_valid)
    np.save("snr_mod_pairs_valid_no_augm.npy",snr_mod_pairs_valid)
